...
return [
    ...
    'products' => [
        ...
        'categories' => [
            ...
            'edit' => [
                ...
                'save-btn'    => 'Mettre à jour la Catégorie',
                'name'        => 'Nom',
                'description' => 'Description',
            ],
            ...
            'delete-failed'  => 'Échec de la suppression de la catégorie.',
        ],
    ...
    'orders' => [
        'index' => [
            'title'          => 'Commandes',
            'create-btn'     => 'Nouvelle Commande',
            'create-success' => 'Commande créée avec succès.',
            'update-success' => 'Commande mise à jour avec succès.',
            'status-updated' => 'Statut de la commande mis à jour avec succès.',
            'delete-success' => 'Commande supprimée avec succès.',
            'delete-failed'  => 'La commande ne peut pas être supprimée.',
        ...
        'create' => [
            ...
            'description'       => 'Description',
            'person'            => 'Client',
            'select-person'     => 'Sélectionner un client',
            'expected-delivery' => 'Date de livraison prévue',
            'has-production'    => 'Avec production',
            'products'          => 'Produits',
            'product-name'      => 'Nom du produit',
            'quantity'          => 'Quantité',
            'price'             => 'Prix unitaire',
            'total'             => 'Total',
            'action'            => 'Action',
            'select-product'    => 'Rechercher un produit',
            'search-products'   => 'Rechercher des produits',
            'add-product'       => 'Ajouter un produit',
            'grand-total'       => 'Total TTC',
            'notes'             => 'Notes',
        ...
        'show' => [
            'order-info'        => 'Informations de la commande',
            ...
            'expected-delivery' => 'Livraison prévue',
            'type'              => 'Type',
            'with-production'   => 'Avec production',
            'without-production'=> 'Sans production',
            'description'       => 'Description',
            'notes'             => 'Notes',
            'delayed'           => 'Commande en retard',
            'delayed-message'   => 'Cette commande est en retard de :days jour(s).',
            'at-risk'           => 'Commande à risque',
            'at-risk-message'   => 'Cette commande sera livrée dans :days jour(s).',
            'products'          => 'Produits',
            'product-name'      => 'Nom du produit',
            'quantity'          => 'Quantité',
            'price'             => 'Prix unitaire',
            ...
            'status-notes'      => 'Notes (optionnel)',
            'update-status-btn' => 'Mettre à jour le statut',
            'edit-btn'          => 'Modifier',
        ],
    ...
    'warehouse' => [
        'stock-entries' => [
            ...
            'create' => [
                ...
                'save-btn'        => 'Enregistrer l\'Entrée',
                'general'         => 'Général',
                'general-info'    => 'Informations générales sur l\'entrée de stock',
                'date-appro'      => 'Date d\'Approvisionnement',
                'supplier'        => 'Fournisseur',
                'select-person'   => 'Sélectionner un fournisseur',
                'notes'           => 'Notes',
                'products'        => 'Produits',
                'products-info'   => 'Ajouter les produits et leurs quantités',
                'product-name'    => 'Nom du Produit',
                'quantity'        => 'Quantité',
                'action'          => 'Action',
                'add-product'     => 'Ajouter un Produit',

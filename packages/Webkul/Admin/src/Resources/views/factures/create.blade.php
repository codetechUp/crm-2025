...
<x-admin::layouts>
    ...
    <form
        method="POST"
        action="{{ route('admin.factures.store').'?'.http_build_query(array_merge(
                            ...
                            <div class="flex gap-4">
                                <x-admin::form.control-group class="w-full">
                                    ...
                                    <x-admin::form.control-group.control
                                        type="text"
                                        name="tva_rate"
                                        value="{{ old('tva_rate', $defaultTvaRate) }}"
                        ...
                        <div class="flex w-full justify-between gap-x-5">
                           Acompte
                            <x-admin::form.control-group.control
                                ...
                                ::errors="errors"
                                :label="trans('admin::app.quotes.create.acompte')"
                                :placeholder="trans('admin::app.quotes.create.acompte')"
            ...
            app.component('v-quote-item-list', {
                ...
                mounted() {
                    ...
                    if (tvaRateInput) {
                        ...
                        this.tvaRate = parseFloat(tvaRateInput.value) || {{ $defaultTvaRate ?? 0 }};
                    }
                },

<x-admin::layouts>
    <x-slot:title>
        @lang('admin::app.orders.edit.title')
    </x-slot>

    <x-admin::form :action="route('admin.orders.update', $order->id)" method="PUT">
            ...
            <div class="flex items-center justify-between rounded-lg border border-gray-200 bg-white px-4 py-2 text-sm dark:border-gray-800 dark:bg-gray-900 dark:text-gray-300">
                ...
                <div class="flex items-center gap-x-2.5">
                    <button type="submit" class="primary-button">
                        @lang('admin::app.orders.edit.save-btn')
                    </button>
                </div>
            </div>
                ...
                <div class="w-1/2 max-md:w-full">
                    <x-admin::form.control-group class="mb-4">
                        <x-admin::form.control-group.label class="required">
                            @lang('admin::app.orders.edit.subject')
                    ...
                    <x-admin::form.control-group class="mb-4">
                        <x-admin::form.control-group.label>
                            @lang('admin::app.orders.edit.description')
                        </x-admin::form.control-group.label>
                    ...
                    <div class="flex gap-4 mb-4">
                        <x-admin::form.control-group class="flex-1">
                            <x-admin::form.control-group.label class="required">
                                @lang('admin::app.orders.edit.person')
                            </x-admin::form.control-group.label>

                            <x-admin::form.control-group.control
                                type="text"
                                name="person_name"
                                :value="$order->person->name ?? ''"
                                disabled
                            />

                            <input type="hidden" name="person_id" value="{{ $order->person_id }}" />
                        ...
                        <x-admin::form.control-group class="flex-1">
                            <x-admin::form.control-group.label>
                                @lang('admin::app.orders.edit.expected-delivery')
                            </x-admin::form.control-group.label>
                    ...
                    <x-admin::form.control-group class="mb-4">
                        <x-admin::form.control-group.label>
                            @lang('admin::app.orders.edit.has-production')
                        </x-admin::form.control-group.label>
                        ...
                        <x-admin::form.control-group.control
                            ...
                            name="has_production"
                            value="1"
                            :checked="old('has_production') ?? $order->has_production"
                        />
                    </x-admin::form.control-group>
                    ...
                    <div class="mb-4">
                        <label class="block text-sm font-medium mb-2 dark:text-white">
                            @lang('admin::app.orders.edit.products')
                        </label>
                    ...
                    <x-admin::form.control-group>
                        <x-admin::form.control-group.label>
                            @lang('admin::app.orders.edit.notes')
                        </x-admin::form.control-group.label>
                    ...
                    <x-admin::table>
                        <x-admin::table.thead>
                            <x-admin::table.thead.tr>
                                <x-admin::table.th>@lang('admin::app.orders.edit.product-name')</x-admin::table.th>
                                <x-admin::table.th class="text-center">@lang('admin::app.orders.edit.quantity')</x-admin::table.th>
                                <x-admin::table.th class="text-center">@lang('admin::app.orders.edit.price')</x-admin::table.th>
                                <x-admin::table.th class="text-center">@lang('admin::app.orders.edit.total')</x-admin::table.th>
                                <x-admin::table.th v-if="products.length > 1" class="!px-2 ltr:text-right rtl:text-left">@lang('admin::app.orders.edit.action')</x-admin::table.th>
                            </x-admin::table.thead.tr>
                        </x-admin::table.thead>
                ...
                <x-admin::table.td>
                    <x-admin::form.control-group class="!mb-0">
                        <x-admin::lookup
                            ...
                            :placeholder="trans('admin::app.orders.edit.search-products')"
                        />
                    </x-admin::form.control-group>
                </x-admin::table.td>
                ...
                <x-admin::table.td class="!px-2 ltr:text-right rtl:text-left">
                    <x-admin::form.control-group class="!mb-0">
                        <x-admin::form.control-group.control
                            ...
                            ::errors="errors"
                            :label="trans('admin::app.orders.edit.quantity')"
                            :placeholder="trans('admin::app.orders.edit.quantity')"
                ...
                <x-admin::table.td class="!px-2 ltr:text-right rtl:text-left">
                    <x-admin::form.control-group class="!mb-0">
                        <x-admin::form.control-group.control
                            ...
                            rules="required|decimal:4"
                            ::errors="errors"
                            :label="trans('admin::app.orders.edit.price')"
                            :placeholder="trans('admin::app.orders.edit.price')"
                ...
                <x-admin::table.td class="!px-2 ltr:text-right rtl:text-left">
                    <x-admin::form.control-group class="!mb-0">
                        <x-admin::form.control-group.control
                            ...
                            rules="required|decimal:4"
                            ::errors="errors"
                            :label="trans('admin::app.orders.edit.total')"
                            :placeholder="trans('admin::app.orders.edit.total')"
                            :allowEdit="false"
                            position="center"
